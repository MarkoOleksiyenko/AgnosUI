...
import {BaseWidgetDirective, callWidgetFactory, ComponentTemplate, SlotDirective, UseDirective, UseMultiDirective} from '@agnos-ui/angular-headless';
...
@Component({
	changeDetection: ChangeDetectionStrategy.OnPush,
	imports: [UseDirective, UseMultiDirective, SlotDirective],
	selector: '[auDrawer]',
	template: `
		...
		<div [auUseMulti]="[directives.drawerPortalDirective, directives.drawerDirective]">
			...
			<div [auUse]="directives.splitterDirective" class="splitter"></div>
		</div>
