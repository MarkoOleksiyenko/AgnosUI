...
- Utilities to navigate the items:
  ...
  - `focusFirstLeft` - method to focus the element at the left-end of the list and will do the opposite in a RTL configuration
  - `focusFirstRight` - method to focus the element at the right-end of the list and will do the opposite in a RTL configuration
  - `focusLeft` - method to focus the next focusable element to the left of the currently focused element and will do the opposite in a RTL configuration
  - `focusRight` - method to focus the next focusable element to the right of the currently focused element and will do the opposite in a RTL configuration
